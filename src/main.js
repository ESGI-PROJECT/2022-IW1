...
import { setRessources, setRessource, getRessources, getRessource, setCartRessource, getCartRessource } from './idbHelper';
...
(async (root) => {
  ...
  page('/cart', async (ctx) => {
    ...
    if (NETWORK_STATE) {
      ...
      storedProducts = await setCartRessource(cart)
    } else {
